...
;  Date/Time: 8/11/2014 5:50:23 PM
;  Info: http://www.mikroe.com


; ADDRESS	OPCODE	ASM
; ----------------------------------------------
$0000	$2985			GOTO	_main
$019C	$	_Delay_22us:
...
$01AB	$0195			CLRF	CCPR1L, 1
$01AC	$1217			BCF	CCP1CON, 4
$01AD	$1297			BCF	CCP1CON, 5
$01AE	$0008			RETURN
$01A3	$	_PWM2_Init:
$01A3	$1303			BCF	STATUS, RP1
$01A4	$1283			BCF	STATUS, RP0
$01A5	$019B			CLRF	CCPR2L, 1
$01A6	$121D			BCF	CCP2CON, 4
$01A7	$129D			BCF	CCP2CON, 5
$01A8	$0008			RETURN
$0110	$	_Adc_Read:
...
;SVDrPIC.c,55 :: 		Delay_us(PUMP_ON_TIME - 210);
$017E	$3081			MOVLW	129
